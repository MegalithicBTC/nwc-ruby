...
RSpec.describe NwcRuby::NIP47::Notification do
  ...
  it 'parses a kind 23197 (NIP-44 v2) notification' do
    ct = NwcRuby::NIP44::Cipher.encrypt(notification_payload, wallet_priv, client_pub)
    event = NwcRuby::Event.new(
      pubkey: wallet_pub,
      kind: NwcRuby::NIP47::Methods::KIND_NOTIFICATION_NIP44,
      tags: [['p', client_pub]],
      content: ct
    ).sign!(wallet_priv)
  ...
  it 'parses a kind 23196 (NIP-04) notification' do
    ct = NwcRuby::NIP04::Cipher.encrypt(notification_payload, wallet_priv, client_pub)
    event = NwcRuby::Event.new(
      pubkey: wallet_pub,
      kind: NwcRuby::NIP47::Methods::KIND_NOTIFICATION_NIP04,
      tags: [['p', client_pub]],
      content: ct
    ).sign!(wallet_priv)
