...
RSpec.describe NwcRuby::ConnectionString do
  ...
  it 'rejects missing wallet pubkey' do
    ...
    end.to raise_error(NwcRuby::InvalidConnectionStringError)
  end
  ...
  it 'rejects missing relay' do
    ...
    end.to raise_error(NwcRuby::InvalidConnectionStringError, /relay/)
  end
