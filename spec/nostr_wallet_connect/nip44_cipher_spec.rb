...
RSpec.describe NostrWalletConnect::NIP44::Cipher do
  ...
  describe 'round-trip encryption' do
    ...
    it 'rejects a tampered MAC' do
      ...
      end.to raise_error(NostrWalletConnect::EncryptionError, /MAC/)
    end
    ...
    it 'rejects the wrong version byte' do
      ...
      expect do
        described_class.decrypt(tampered, bob_priv, alice_pub)
      end.to raise_error(NostrWalletConnect::EncryptionError, /version/)
    end
  end
end
