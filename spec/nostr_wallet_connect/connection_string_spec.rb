...
RSpec.describe NostrWalletConnect::ConnectionString do
  ...
  def build(params_hash = {})
    ...
    params   = defaults.merge(params_hash) { |_, old, new| Array(new) }
  ...
  it "rejects missing wallet pubkey" do
    ...
    }.to raise_error(NostrWalletConnect::InvalidConnectionStringError)
  end
  ...
  it "rejects missing relay" do
    ...
    }.to raise_error(NostrWalletConnect::InvalidConnectionStringError, /relay/)
  end
