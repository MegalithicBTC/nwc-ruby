...
RSpec.describe NostrWalletConnect::Event do
  let(:priv) { NostrWalletConnect::Crypto::Keys.generate_private_key }
  let(:pub)  { NostrWalletConnect::Crypto::Keys.public_key_from_private(priv) }
